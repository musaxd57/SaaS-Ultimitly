...
const BOOLEAN_FIELDS = ["autoReplyHospitable", "autoWelcome", "autoCheckin", "autoCheckout", "autoHoldingReplyEnabled", "autoTaskFromMessageEnabled", "autoSupplyRequestEnabled", "icalShowGuestName"] as const;
