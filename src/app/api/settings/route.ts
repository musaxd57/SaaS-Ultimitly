...
const BOOLEAN_FIELDS = ["autoReplyHospitable", "autoWelcome", "autoCheckin", "autoCheckout", "autoHoldingReplyEnabled", "autoTaskFromMessageEnabled", "icalShowGuestName"] as const;
