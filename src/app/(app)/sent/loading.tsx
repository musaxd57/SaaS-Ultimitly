// ---------------------------------------------------------------------------
// GÖNDERİLENLER — yükleniyor iskeleti.
//
// SORUN (mesajlar sayfasında çözülmüştü, buraya taşınmamıştı): tür filtre çipleri
...
export default function Loading() {
  return (
    <div className="space-y-4" aria-busy="true" aria-live="polite">
      <span className="sr-only">Gönderilenler yükleniyor…</span>
