...
| **OAuth (bağlanma · refresh CAS · disconnect/reconnect yarışı)** | `integration/hospitable-oauth`, `hospitable-oauth-context`, `hospitable-credentials` (F04: gecikmiş refresh disconnect'i diriltmez / reconnect'i ezmez) | ✅ |
