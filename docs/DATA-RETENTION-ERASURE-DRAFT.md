...
> Kaynaklar resmî: 6698 sayılı Kanun (m.5, m.7, m.11, m.13), Kişisel Verilerin Silinmesi,
> Yok Edilmesi veya Anonim Hale Getirilmesi Hakkında Yönetmelik (RG 28.10.2017/30224;
> m.8-12), KVKK Kurulu karar özetleri (2021/1104, 2021/847, 2020/481, 2020/93).
> Yorum katmanı **[HUKUK KARARI]** ile işaretlidir — avukat onayı bağlayıcıdır.
...
3. **Yeni-veri ayrımı:** `erasedAt` SONRASI gerçekten yeni mesaj/rezervasyon bloklanmaz
   (yeni işleme faaliyeti) — **[HUKUK KARARI]** bu sınırın onayı.
...
6. **Durum: [HUKUK KARARI] bekliyor** — kapsam/istisna onayı gelmeden kod yazılmayacak;
   tasarım hazır, ayrı tur.
