...
- ⏳ Kalan opsiyon (kullanıcı ilgili ama tentative): **AI "bugün al" özeti** — deterministik liste zaten net rakam veriyor,
  bu KOZMETİK. akashML (OpenAI-uyumlu, GLM-5.2, ~8s, ucuz) ile env-gated + buton-tetikli (sayfa bloklamaz) + PII göndermeden
  kurulabilir. Ayrıca **düşük-stok takibi** = ayrı/daha büyük iş (elde-stok girişi + decrement). İkisi de launch-blocker DEĞİL.
