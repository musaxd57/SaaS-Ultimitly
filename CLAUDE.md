...
- **✅ STOK TAKİBİ + MİSAFİR-+1 UYGULANDI (2026-07-10, commit `9e48a85`, migration 12) — kullanıcı "ikisini de yap":**
  ...
  - migration 12: 1 nullable kolon + 1 yeni tablo (dolu tabloya ALTER YOK). Taze PG'de 00→12 sıfır-drift. resetDb güncellendi.
    +18 test. **726 test yeşil.** ⚠️ v1 tavizler (canlıda izle): istek 7-gün sonra kendiliğinden düşer (manuel "karşılandı"
    yok); stok ELLE güncellenmezse kayar (host'a bağlı — girmezse brüt görünür, güvenli default).
