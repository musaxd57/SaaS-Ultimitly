...
- **✅ +1 SERTLEŞTİRME (2026-07-10, commit sonraki, migration 13 — codex+adversarial review bulguları):** kullanıcı "herkese
  ...
  - **+18 test (12'de) + toggle-OFF/ON + 4 FP örneği. 729 test yeşil.** ⚠️ v1 taviz: istek 7-gün sonra kendiliğinden düşer
    (manuel "karşılandı" yok); stok ELLE güncellenmezse kayar (girmezse brüt — güvenli default). Ungated kısa pencerede prod'a
    düşmüş olası FP satırları 7-günde kendiliğinden expire (zararsız).
