...
(`trialEndingSoonEmail` ~2g kala / `trialEndedEmail`). +7 test (445 yeşil). Env: `TRIAL_REMINDER_DAYS` (vars.2),
`APP_BASE_URL` (vars. www). **⏳ İlk gerçek gönderimi kullanıcıyla birlikte test et** (e-posta akışı kuralı).
